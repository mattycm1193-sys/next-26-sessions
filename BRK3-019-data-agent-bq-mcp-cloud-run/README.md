...
- **Real-time token streaming** of thoughts and responses using SSE.
- **Interactive Authentication for MCP Tools**, to be used with BigQuery MCP.
- **Tool calls, results, and artifacts** visualization.
...
3. Copy `.env.sample` as `.env`, and specify configuration values:
...
5. Open your browser and navigate to `http://localhost:8080` to interact with the agent.
